package com.infnet.tp3.infrastructure.config;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (productRepository.count() == 0) {
            ...
            System.out.println("Backend Principal: Banco de dados populado com " + seedProducts.size() + " produtos de demonstração.");
        }
    }
}
